...
using Jellyfin.Plugin.OpenDouban.Response;
...
namespace Jellyfin.Plugin.OpenDouban.Service
{
    public abstract class BaseProvider
    {
        ...
        /// </summary>
        public const string ProviderID = "OpenDoubanID";
        ...
        {
            this._logger = logger;
            this._config = OpenDoubanPlugin.Instance == null ?
                               new Configuration.PluginConfiguration() :
                               OpenDoubanPlugin.Instance.Configuration;
